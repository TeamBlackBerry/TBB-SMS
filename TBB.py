...
\033[1;37m
\033[1;31m---------------------------------------
\033[1;35mCREATED BY : \033[33mMohammad Alamin
\033[1;35mGITHUB     : \033[1;33mhttps://github.com/TeamBlackBerry
\033[1;35mFACEBOOK   : \033[1;33mMd Alamin Hossen
...
def sms_bombing():
    ...
    for sms in range(limit):
        ...
        print "\033[1;31m--------------------------"
        if sms_limit == limit:
           os.system('xdg-open https://youtube.com/channel/UCsOY8hrMZiq5aksWdgzaLLw')
def intro():
    os.system('clear')
    print logo
    print ""
